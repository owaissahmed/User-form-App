import {
  ...
  const Nawazish = ({navigation}) => {
    ...
    function gotoQafila() {
      navigation.navigate('NawazishQafila');
    }
    function gotoInfiradi() {
      navigation.navigate('NawazishInfiradi');
    }
    function gotoSunnah() {
      navigation.navigate('NawazishSunnah');
    }
    function gotoCourse() {
      navigation.navigate('NawazishCourse');
    }
    function gotoMukaamal() {
      navigation.navigate('NawazishMukammal');
    }
    function gotoMoqoof() {
      navigation.navigate('NawazishMoqoof');
    }
    function gotoChodgae() {
      navigation.navigate('NawazishChodgae');
    }
