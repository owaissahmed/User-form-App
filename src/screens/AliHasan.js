import {
  ...
  const AliHasan = ({navigation}) => {
    ...
    function gotoQafila() { 
      navigation.navigate('AliHasanQafila');
    }
    function gotoInfiradi() {
      navigation.navigate('AliHasanInfiradi');
    }
    function gotoSunnah() {
      navigation.navigate('AliHasanSunnah');
    }
    function gotoCourse() {
      navigation.navigate('AliHasanCourse');
    }
    function gotoMukaamal() {
      navigation.navigate('AliHasanMukaamal');
    }
    function gotoMoqoof() {
      navigation.navigate('AliHasanMoqoof');
    }
    function gotoChodgae() {
      navigation.navigate('AliHasanChodgae');
    }
