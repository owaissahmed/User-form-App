...
const KarachiThree = ({navigation}) => {
  ...
  function gotoChutti() {
    navigation.navigate('karachiThreeChutti');
  }
  function gotoQafila() {
    navigation.navigate('karachiThreeQafila');
  }
  function gotoInfiradi() {
    navigation.navigate('karachiThreeInfiradi');
  }
  function gotoSunnah() {
    navigation.navigate('karachiThreeSunnah');
  }
  function gotoCourse() {
    navigation.navigate('KarachiThreeCourse');
  }
  function gotoMukaamal() {
    navigation.navigate('KarachiThreeMukammal');
  }
  function gotoMoqoof() {
    navigation.navigate('KarachiThreeMoqoof');
  }
  function gotoChodgae() {
    navigation.navigate('KarachiThreeChodgae');
  }
