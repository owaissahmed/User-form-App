import {
  ...
  const SindhTwo = ({navigation}) => {
    ...
    function gotoChutti() {
      navigation.navigate('sindhTwoChutti');
    }
    function gotoQafila() {
      navigation.navigate('sindhTwoQafila');
    }
    function gotoInfiradi() {
      navigation.navigate('sindhTwoInfiradi');
    }
    function gotoSunnah() {
      navigation.navigate('sindhTwoSunnah');
    }
    function gotoCourse() {
      navigation.navigate('SindhTwoCourse');
    }
    function gotoMukaamal() {
      navigation.navigate('SindhTwoMukammal');
    }
    function gotoMoqoof() {
      navigation.navigate('SindhTwoMoqoof');
    }
    function gotoChodgae() {
      navigation.navigate('SindhTwoChodgae');
    }
