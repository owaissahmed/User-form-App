import {
  ...
  const Hasan = ({navigation}) => {
    ...
    function gotoChutti() {
      navigation.navigate('HasanChutti');
    }
    function gotoQafila() {
      navigation.navigate('HasanQafila');
    }
    function gotoInfiradi() {
      navigation.navigate('HasanInfiradi');
    }
    function gotoSunnah() {
      navigation.navigate('HasanSunnah');
    }
    function gotoCourse() {
      navigation.navigate('HasanCourse');
    }
    function gotoMukaamal() {
      navigation.navigate('HasanMukammal');
    }
    function gotoMoqoof() {
      navigation.navigate('HasanMoqoof');
    }
    function gotoChodgae() {
      navigation.navigate('HasanChodgae');
    }
