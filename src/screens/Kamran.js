import {
  ...
  import KamranChodgae from './KamranChodgae';
  const devicewidth = Dimensions.get('window').width;
  const deviceheight = Dimensions.get('window').height;
  
  const Kamran = ({navigation}) => {
    ...
    function gotoChutti() {
      navigation.navigate('KamranChutti');
    }
    function gotoQafila() {
      navigation.navigate('KamranQafila');
    }
    function gotoInfiradi() {
      navigation.navigate('KamranInfiradi');
    }
    function gotoSunnah() {
      navigation.navigate('KamranSunnah');
    }
    function gotoCourse() {
      navigation.navigate('KamranCourse');
    }
    function gotoMukaamal() {
      navigation.navigate('KamranMukammal');
    }
    function gotoMoqoof() {
      navigation.navigate('KamranMoqoof');
    }
    function gotoChodgae() {
      navigation.navigate('KamranChodgae');
    }
