import {
  ...
  const RashidNoori = ({navigation}) => {
    ...
    var total = khi1Infiradi + khi1chutti + khi1darussunnah + khi1qafila + khi1course + khi1chodgae;
     ...
     function gotoChutti() {
      navigation.navigate('RashidNooriChutti');
    }
    function gotoQafila() {
      navigation.navigate('RashidNooriQafila');
    }
    function gotoInfiradi() {
      navigation.navigate('RashidNooriInfiradi');
    }
    function gotoSunnah() {
      navigation.navigate('RashidNooriSunnah');
    }
    function gotoCourse() {
      navigation.navigate('RashidNooriCourse');
    }
    function gotoMukaamal() {
      navigation.navigate('RashidNooriMukammal');
    }
    function gotoMoqoof() {
      navigation.navigate('RashidNooriMoqoof');
    }
    function gotoChodgae() {
      navigation.navigate('RashidNooriChodgae');
    }
