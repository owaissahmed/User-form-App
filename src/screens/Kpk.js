import {
  ...
  const Kpk = ({navigation}) => {
    ...
    function gotoChutti() {
      navigation.navigate('KpkChutti');
    }
    function gotoQafila() {
      navigation.navigate('KpkQafila');
    }
    function gotoInfiradi() {
      navigation.navigate('KpkInfiradi');
    }
    function gotoSunnah() {
      navigation.navigate('KpkSunnah');
    }
    function gotoCourse() {
      navigation.navigate('KpkCourse');
    }
    function gotoMukaamal() {
      navigation.navigate('KpkMukammal');
    }
    function gotoMoqoof() {
      navigation.navigate('KpkMoqoof');
    }
    function gotoChodgae() {
      navigation.navigate('KpkChodgae');
    }
