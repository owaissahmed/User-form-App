...
const Sahil = ({navigation}) => {
  ...
  var total =
    khi1Infiradi + khi1chutti + khi1darussunnah + khi1qafila + khi1course;
  ...
  function gotoCourse() {
    navigation.navigate('SahilCourse');
  }
  function gotoMukaamal() {
    navigation.navigate('SahilMukammal');
  }
  function gotoMoqoof() {
    navigation.navigate('SahilMoqoof');
  }
  function gotoChodgae() {
    navigation.navigate('SahilChodgae');
  }
