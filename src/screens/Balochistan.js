...
const Balochistan = ({navigation}) => {
  ...
  function gotoCourse() {
    navigation.navigate('BalochistanCourse');
  }
  function gotoMukaamal() {
    navigation.navigate('BalochistanMukammal');
  }
  function gotoMoqoof() {
    navigation.navigate('BalochistanMoqoof');
  }
  function gotoChodgae() {
    navigation.navigate('BalochistanChodgae');
  }
