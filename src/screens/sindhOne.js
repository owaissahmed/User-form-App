import {
  ...
  const SindhOne = ({navigation}) => {
    ...
    function gotoCourse() {
      navigation.navigate('SindhOneCourse');
    }
    function gotoMukaamal() {
      navigation.navigate('SindhOneMukammal');
    }
    function gotoMoqoof() {
      navigation.navigate('SindhOneMoqoof');
    }
    function gotoChodgae() {
      navigation.navigate('SindhOneChodgae');
    }
