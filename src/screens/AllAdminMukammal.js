  ...
  return (
    <View style={styles.main}>
      ...
      <View style={styles.squarediv}>
        ...
        <TouchableOpacity onPress={()=>navigation.navigate('NawazishMukammal')}>
          <View style={styles.square}>
        ...
        <TouchableOpacity onPress={()=>navigation.navigate('HasanMukammal')}>
          <View style={styles.square}>
            <Text allowFontScaling={false} style={styles.squaretext__}>
              Hasan Madani
            </Text>
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate('RashidLahoriMukammal')}>
          <View style={styles.square}>
            <Text allowFontScaling={false} style={styles.squaretext}>
            Rashid Lahori
            </Text>
