  ...
  return (
    <View style={styles.main}>
      ...
      <View style={styles.squarediv}>
        ...
        <TouchableOpacity onPress={()=>navigation.navigate('HasanChutti')}>
          <View style={styles.square}>
            <Text allowFontScaling={false} style={styles.squaretext__}>
              Hasan Madani
            </Text>
        ...
        <TouchableOpacity onPress={()=>navigation.navigate('AbdulWakeelChutti')}>
          <View style={styles.square}>
            <Text allowFontScaling={false} style={styles.squaretext}>
              Fuzail
            </Text>
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate('KamranChutti')}>
          <View style={styles.square}>
            <Text allowFontScaling={false} style={styles.squaretext}>
            Kamran
            </Text>
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate('AliHasanChutti')}>
          <View style={styles.square}>
            <Text allowFontScaling={false} style={styles.squaretext}>
            Ali Hasan
            </Text>
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate('RashidNooriChutti')}>
          <View style={styles.square}>
            <Text allowFontScaling={false} style={styles.squaretext}>
            Rashid Noori
            </Text>
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate('RashidLahoriChutti')}>
          <View style={styles.square}>
            <Text allowFontScaling={false} style={styles.squaretext}>
            Rashid Lahori
            </Text>
