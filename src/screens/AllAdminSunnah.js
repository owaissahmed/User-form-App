    ...
    return (
      <View style={styles.main}>
        ...
        <View style={styles.squarediv}>
          ...
          <TouchableOpacity onPress={()=>navigation.navigate('NawazishSunnah')}>
            <View style={styles.square}>
          ...
          <TouchableOpacity onPress={()=>navigation.navigate('HasanSunnah')}>
            <View style={styles.square}>
              <Text allowFontScaling={false} style={styles.squaretext__}>
                Hasan Madani
              </Text>
          ...
          <TouchableOpacity
          onPress={() => navigation.navigate('RashidNooriSunnah')}>
          <View style={styles.square}>
            <Text allowFontScaling={false} style={styles.squaretext}>
            Rashid Noori
            </Text>
